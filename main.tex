...
\begin{document}
	...
	\begin{minipage}[t]{0.3\textwidth}\hrule height 0pt width 0pt%
		\small%
		\icontext{MapMarker}{12}{Hamburg, Germany}\\
		\icontext{Phone}{12}{+420 111 111 11}\\
		\icontext{At}{12}{\href{mailto:z.rezaie87@gmail.com}{z.rezaie87@gmail.com}}\\
	\end{minipage}%
	\begin{minipage}[t]{0.3\textwidth}\hrule height 0pt width 0pt%
		\small%
		\icontext{Github}{12}{\href{https://github.com/Za-Re}{Github}}\\
		\icontext{Twitter}{12}{\href{https://www.linkedin.com/in/zararezaie/}{LinkedIn}}\\
	\end{minipage}%
	...
	\begin{minipage}[t]{0.5\textwidth}\hrule height 0pt width 0pt%
		...
		\begin{barchart}{10}{5.5}{red}{white}{black}{black}{black}{black}
			\baritem{50}{Python}{70}
			\baritem{80}{AWS}{70}
			\baritem{80}{Github Actions}{80}
			\baritem{80}{Terraform}{70}
			\baritem{80}{Kubernetes}{50}
